...
#     python docs/exercises/07_temporal_ensembling.py
# It self-checks. Reference solution: docs/exercises/solutions/07_temporal_ensembling.py
# (Try hard before peeking. These build the core math of the policies in docs/.)

"""
Exercise 07: ACT temporal ensembling.
